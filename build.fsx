...
// Library ------------------------------------------------------------------------
Target.create "Lib_Build" (fun _ -> build "Be.Vlaanderen.Basisregisters.BlobStore")
Target.create "Lib_Test" (fun _ -> [ "test" @@ "Be.Vlaanderen.Basisregisters.BlobStore.Tests" ] |> List.iter testWithDotNet)
Target.create "Lib_Publish" (fun _ -> publish "Be.Vlaanderen.Basisregisters.BlobStore")
